 ...
 * 诱导界面
 */
public class TTSDemoGuideActivity extends Activity {

    private static final String TAG = TTSDemoGuideActivity.class.getName();
    ...
    private void showOverlay() {
        ...
        BNItemizedOverlay overlay = new BNItemizedOverlay(
                TTSDemoGuideActivity.this.getResources().getDrawable(R.drawable
                        .navi_guide_turn));
